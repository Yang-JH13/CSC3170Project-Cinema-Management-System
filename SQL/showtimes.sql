...
CREATE TABLE `showtimes`  (
  ...
  PRIMARY KEY (`ShowtimeID`) USING BTREE,
  INDEX `MovieID`(`MovieID` ASC) USING BTREE,
  CONSTRAINT `showtimes_ibfk_1` FOREIGN KEY (`MovieID`) REFERENCES `movies` (`MovieID`) ON DELETE RESTRICT ON UPDATE RESTRICT
